...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
      <div class="container">
      <?php if ($this->session->userdata('status') == 'pasienlogin'):?>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          <li class="nav-item mx-0 mx-lg-1">
            ...
            <?php else: ?>
               <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="<?php echo base_url();?>login_pasien">Masuk</a>
            </li>
            <?php endif; ?>
          </ul>
        </div>
